...
const toParsedMockInteractionWithNormalizedHeaders = (parsedMockInteraction) => (Object.assign(Object.assign({}, parsedMockInteraction), { requestHeaders: (0, to_map_with_lower_case_keys_1.toMapWithLowerCaseKeys)(parsedMockInteraction.requestHeaders), responseHeaders: (0, to_map_with_lower_case_keys_1.toMapWithLowerCaseKeys)(parsedMockInteraction.responseHeaders) }));
